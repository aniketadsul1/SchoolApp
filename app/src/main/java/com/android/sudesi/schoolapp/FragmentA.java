...
public class FragmentA extends Fragment {
    ...
    private void init(View rootView) {
        ...
        //EditText
        edt_roll_no = (EditText)rootView.findViewById(R.id.edt_roll_no);
        ...
        edt_Parent_Mob_no = (EditText)rootView.findViewById(R.id.edt_Parent_Mob_no);
        edt_std = (EditText)rootView.findViewById(R.id.edt_std);
        edt_div = (EditText)rootView.findViewById(R.id.edt_div);
